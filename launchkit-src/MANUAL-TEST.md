...
|---|---|---|---|
| 1 | Click the logo, top-left | Goes to `/dashboard` from anywhere in the app; on the landing page it goes to `/` | none |
...
| 12 | Click **Approve** on the asset | Gate 2 stamped | none |
| 13 | **Targets** → tick 3 venues | Gate 3; selections persist on reload | none |
