...
export const spec = {
  ...
  plates: [
    { id: 'scene', for: 'reel', when: '0.0-3.4', size: '1024x1536', grade: 'cold', hint: 'the room where these users do this work, wide, from the back or above, with the crowd and the props of their world in view (the tables, the screens, the stage, the clock, the stacks, the badges), the hour and the load; a stranger must name the world from the room alone; nobody is the subject yet', example: 'A network operations room at two in the morning: a wall of six glowing dashboards, three on-call engineers at a long desk beneath them with headsets around their necks, a rack of servers blinking behind glass, a printed on-call rota pinned to a whiteboard, cold cans and a pager on the desk, seen wide from the back of the room in the light of the screens.' },
    { id: 'pile', for: 'reel', when: '3.4-6.5', size: '1024x1536', grade: 'cold', hint: 'the one user doing this job by hand, close, surrounded by the props of the world (the stacks, the screens, the badge, the list), the job itself visible in their hands, tired and human, not looking at the camera', example: 'One on-call engineer alone at that desk at two in the morning, hood up, a headset on, a pager lit beside a laptop showing a wall of alert rows, a thick runbook binder open and page-marked, the dashboard wall behind her half red, one hand on her forehead, reading, not looking at the camera.' },
    { id: 'arrival', for: 'reel', when: '20.0-22.0', size: '1024x1536', grade: 'warm', hint: 'the same person after the app, in the same world: calmer, upright, the props of the job tidied around them (the stacks squared away, the screens calm, the badge still on) and the place still in frame behind them (the stage, the screens, the banners, the crowd thinning out), so the after picture names the world as fast as the before; the room lighter, space to breathe', example: 'The same engineer the next morning at the same desk: the headset hung on the monitor, the pager dark, the runbook closed, the dashboard wall behind her all green and the server rack still blinking behind its glass, coffee in hand, standing relaxed by the window as daylight comes in.' },
    { id: 'hero', for: 'cards', when: 'launch images', size: '1536x1024', grade: 'warm', hint: 'the launch image: the users and the place at a glance, landscape, the props of the world around them, the subject in the right two thirds so a headline can sit on the left', example: 'That engineer and two colleagues in the operations room by day, gathered in the right two thirds of the frame around one screen showing a calm status board, the dashboard wall and the server rack behind them, the left third of the frame open with a plain wall and soft daylight, wide landscape shot.' },
  ],
